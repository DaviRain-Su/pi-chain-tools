...
- `compose`: unsigned transfer transaction builders (SOL/SPL, legacy + v0), native staking builders (create+delegate/delegate/deactivate/withdraw), Jupiter & Raydium swap builders
- `execute`: simulate, send, sign+send, confirm, airdrop, SOL transfer, SPL transfer, native stake actions (create+delegate/delegate/deactivate/withdraw), one-shot Jupiter & Raydium swap
...
- Native stake operation tools: create+delegate/delegate/deactivate/withdraw
