...
const DEFAULT_CONFIRM_TEXT = "ASTERDEX_EXECUTE_LIVE";
...
export function runAsterDexExecSafe(
	...
	const maxAmountRaw = BigInt(
		String(env.BSC_AUTONOMOUS_ASTERDEX_MAX_AMOUNT_RAW || "1000000000000000000"),
	);
	const liveCommandTemplate = String(
		env.BSC_AUTONOMOUS_ASTERDEX_LIVE_COMMAND || "",
	).trim();
	...
	const commandResult = spawnSync(liveCommand, {
		...
		timeout: Number.parseInt(
			String(env.BSC_AUTONOMOUS_ASTERDEX_EXECUTE_TIMEOUT_MS || "120000"),
			10,
		),
	});
