...
const checklist = [
	line(
		...
		env.BSC_AUTONOMOUS_ASTERDEX_EXECUTE_ACTIVE || "true",
	),
	line(
		"BSC_AUTONOMOUS_ASTERDEX_LIVE_COMMAND",
		env.BSC_AUTONOMOUS_ASTERDEX_LIVE_COMMAND || "<set-live-command>",
	),
	line("BSC_AUTONOMOUS_ASTERDEX_CONFIRM_TEXT", confirmText),
	line(
		"BSC_AUTONOMOUS_ASTERDEX_MAX_AMOUNT_RAW",
		env.BSC_AUTONOMOUS_ASTERDEX_MAX_AMOUNT_RAW || "1000000000000000000",
	),
	line(
...
const ready =
	parseBoolean(env.BSC_AUTONOMOUS_ASTERDEX_EXECUTE_ACTIVE) &&
	String(env.BSC_AUTONOMOUS_ASTERDEX_LIVE_COMMAND || "").trim();
if (!ready) {
	console.log(
