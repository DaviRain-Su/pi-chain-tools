...
- Unresolved blockers are execute-surface + package-availability/policy gaps (Morpho execute signer API, Venus execute SDK signer surface, Lista official SDK publish, Wombat official execute SDK availability/security-policy compatibility for hard dependency promotion).
